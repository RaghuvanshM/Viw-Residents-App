    ...
    return (
      <View style={{flex: 1}}>
        <ImageBackground
          ...
          <Text style={styles.headings}>Easily customize at any time</Text>
          <Text style={styles.Viewsamartglasfirst}>
            Override the window’s tint setting at any time with this app. Just
            select the room and tint level.
          </Text>
          <View style={styles.sunimage}>
            <Image source={images.control} style={styles.controlimage} />
          </View>
          <View>
            <Text style={styles.Viewsamartglasfirst}>
